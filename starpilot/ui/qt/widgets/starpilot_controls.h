...
class StarPilotConfirmationDialog : public ConfirmationDialog {
  Q_OBJECT

public:
  explicit StarPilotConfirmationDialog(const QString &prompt_text, const QString &confirm_text,
                                       const QString &cancel_text, const bool rich, QWidget *parent);
  static bool toggleReboot(QWidget *parent);
  static bool yesorno(const QString &prompt_text, QWidget *parent);
};

class StarPilotListWidget : public QWidget {
  Q_OBJECT
 public:
  explicit StarPilotListWidget(QWidget *parent = 0) : QWidget(parent), outer_layout(this) {
...
class StarPilotButtonControl : public ParamControl {
  Q_OBJECT
public:
  StarPilotButtonControl(const QString &param, const QString &title, const QString &desc, const QString &icon,
    ...
    QObject::connect(this, &ToggleControl::toggleFlipped, this, &StarPilotButtonControl::refresh);
...
class StarPilotButtonsControl : public AbstractControl {
  Q_OBJECT
public:
  StarPilotButtonsControl(const QString &title, const QString &desc, const QString &icon,
...
class StarPilotButtonToggleControl : public StarPilotButtonControl {
  Q_OBJECT
public:
  StarPilotButtonToggleControl(const QString &param, const QString &title, const QString &desc, const QString &icon,
    ...
    : StarPilotButtonControl(param, title, desc, icon, button_texts, true, exclusive, minimum_button_width), button_params(button_params) {
  ...
  void refresh() override {
    StarPilotButtonControl::refresh();
...
class StarPilotManageControl : public ParamControl {
  Q_OBJECT
public:
  StarPilotManageControl(const QString &param, const QString &title, const QString &desc, const QString &icon) : ParamControl(param, title, desc, icon) {
    key = param.toStdString();
    ...
    QObject::connect(manageButton, &ButtonControl::clicked, this, &StarPilotManageControl::manageButtonClicked);
    QObject::connect(this, &ToggleControl::toggleFlipped, this, &StarPilotManageControl::refresh);
  }
...
class StarPilotParamValueControl : public AbstractControl {
  Q_OBJECT
public:
  StarPilotParamValueControl(const QString &param, const QString &title, const QString &desc, const QString &icon,
    ...
    QObject::connect(&decrement_button, &QPushButton::pressed, this, &StarPilotParamValueControl::decrementPressed);
    QObject::connect(&increment_button, &QPushButton::pressed, this, &StarPilotParamValueControl::incrementPressed);
...
class StarPilotParamValueButtonControl : public StarPilotParamValueControl {
  Q_OBJECT
public:
  StarPilotParamValueButtonControl(const QString &param, const QString &title, const QString &desc, const QString &icon,
                                   float min_value, float max_value, const QString &label, const std::map<float, QString> &value_labels,
                                   ...
                                   : StarPilotParamValueControl(param, title, desc, icon, min_value, max_value, label, value_labels, interval, fast_increase, 200),
  ...
  void refresh() {
    ...
    StarPilotParamValueControl::refresh();
  }

  void showEvent(QShowEvent *event) override {
    refresh();
    StarPilotParamValueControl::showEvent(event);
  }
...
class StarPilotDualParamValueControl : public QFrame {
  Q_OBJECT
public:
  StarPilotDualParamValueControl(StarPilotParamValueControl *control1, StarPilotParamValueControl *control2, QWidget *parent = nullptr) : QFrame(parent), control1(control1), control2(control2) {
...
private:
  StarPilotParamValueControl *control1;
  StarPilotParamValueControl *control2;
};
