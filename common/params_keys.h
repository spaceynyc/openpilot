...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"BoschARadar", {PERSISTENT, BOOL, "0"}},
    {"BlotV2", {PERSISTENT, BOOL, "0"}},
    ...
    {"UseKonikServer", {PERSISTENT, BOOL, "1", "1", 2, SETTINGS_SIMPLE}},
    {"InsightSteeringEnabled", {PERSISTENT, BOOL, "0", "0", 2, SETTINGS_ADVANCED}},
    {"InsightEpsProfile", {PERSISTENT, INT, "0", "0", 2, SETTINGS_ADVANCED}},
    {"InsightBasePid", {PERSISTENT, JSON, "{}", "{}", 0}},
    {"LatPScaleLowSpeed", {PERSISTENT, INT, "100", "100", 2, SETTINGS_ADVANCED}},
    {"LatPScaleStandard", {PERSISTENT, INT, "100", "100", 2, SETTINGS_ADVANCED}},
    {"LatPScaleHighway", {PERSISTENT, INT, "100", "100", 2, SETTINGS_ADVANCED}},
    {"LatIScaleLowSpeed", {PERSISTENT, INT, "100", "100", 2, SETTINGS_ADVANCED}},
    {"LatIScaleStandard", {PERSISTENT, INT, "100", "100", 2, SETTINGS_ADVANCED}},
    {"LatIScaleHighway", {PERSISTENT, INT, "100", "100", 2, SETTINGS_ADVANCED}},
    {"LatFScaleLowSpeed", {PERSISTENT, INT, "100", "100", 2, SETTINGS_ADVANCED}},
    {"LatFScaleStandard", {PERSISTENT, INT, "100", "100", 2, SETTINGS_ADVANCED}},
    {"LatFScaleHighway", {PERSISTENT, INT, "100", "100", 2, SETTINGS_ADVANCED}},
    {"HondaCenterScale", {PERSISTENT, FLOAT, "0.0", "0.0", 2, SETTINGS_ADVANCED}},
    {"HondaCenterBoostThreshold", {PERSISTENT, FLOAT, "3.0", "3.0", 2, SETTINGS_ADVANCED}},
    {"HondaCenterBoostMinSpeed", {PERSISTENT, INT, "50", "50", 2, SETTINGS_ADVANCED}},
    {"NrdrLatRateDamping", {PERSISTENT, INT, "0", "0", 2, SETTINGS_ADVANCED}},
    {"NrdrLatRateDampingFadeSpeed", {PERSISTENT, INT, "30", "30", 2, SETTINGS_ADVANCED}},
    {"NrdrLatStiction", {PERSISTENT, BOOL, "0", "0", 2, SETTINGS_ADVANCED}},
    {"HondaTorqueLowPassFilter", {PERSISTENT, BOOL, "0", "0", 2, SETTINGS_ADVANCED}},
    {"HondaLpfTauLowSpeed", {PERSISTENT, FLOAT, "0.1", "0.1", 2, SETTINGS_ADVANCED}},
    {"HondaLpfTauStandard", {PERSISTENT, FLOAT, "0.1", "0.1", 2, SETTINGS_ADVANCED}},
    {"HondaLpfTauHighway", {PERSISTENT, FLOAT, "0.05", "0.05", 2, SETTINGS_ADVANCED}},
    {"HondaSteerDeltaLimiter", {PERSISTENT, BOOL, "0", "0", 2, SETTINGS_ADVANCED}},
    {"HondaSteerDeltaUp", {PERSISTENT, FLOAT, "3.0", "3.0", 2, SETTINGS_ADVANCED}},
    {"HondaSteerDeltaDown", {PERSISTENT, FLOAT, "3.0", "3.0", 2, SETTINGS_ADVANCED}},
    {"NrdrSteerRatioMode", {PERSISTENT, INT, "1", "1", 2, SETTINGS_ADVANCED}},
    {"NrdrSteerRatioManualCenter", {PERSISTENT, FLOAT, "15.38", "15.38", 2, SETTINGS_ADVANCED}},
    {"NrdrSteerRatioManualFinal", {PERSISTENT, FLOAT, "10.93", "10.93", 2, SETTINGS_ADVANCED}},
    {"InsightKonikStatus", {PERSISTENT, STRING, "", "", 0}},
    {"InsightKonikMigrationId", {PERSISTENT | DONT_LOG, STRING, "", "", 0}},
