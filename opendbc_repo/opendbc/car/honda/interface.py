...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params_sp(stock_cp: structs.CarParams, ret: structs.CarParamsSP, candidate, fingerprint: dict[int, dict[int, int]],
    ...
    if candidate == CAR.HONDA_CIVIC:
      ...
      stock_cp.lateralTuning.pid.kf = 0.00000
      stock_cp.lateralTuning.pid.kpBP, stock_cp.lateralTuning.pid.kpV = [[0, 10, 20], [0.1, 0.09, 0.07]]
      stock_cp.lateralTuning.pid.kiBP, stock_cp.lateralTuning.pid.kiV = [[0, 10, 20], [0.0, 0.0, 0.02]]
